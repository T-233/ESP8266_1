...
const char* ssid = "t111";//连接的路由器的名字
const char* password = "147258369";//连接的路由器的密码
const char* mqtt_server = "132.232.179.207";//服务器的地址 
const int port=1883;//服务器端口号

const char* topic_name = "Control_car/#";//订阅的主题
...
//  Serial.print(callMsg);
  ...
  if(callMsg == "1"){
    ...
    send_control = "A0100000Z";
  }else if(callMsg == "3"){
    send_control = "A0010000Z";
  }else if(callMsg == "4"){
     send_control = "A0001000Z";
  }else if(callMsg == "5"){
    send_control = "A0000100Z";
  }else if(callMsg == "6"){
   send_control = "A0000010Z";
  }else if(callMsg == "7"){
    send_control = "A0000001Z";
  }else{
    
  }
 Serial.print(send_control);
 Serial.flush(); 
 send_control = "A0000000Z";
 callMsg = "";
